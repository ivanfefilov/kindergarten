# Generated by babushka-0.19.0 at 2016-10-18 15:53:46 +0400, from adb5f3cd9e5a1d5efebc002c66a3c77b4c9a6362. b886ec80073c7d303ae62959acec9c0120e70086 
# !!!config valid only for Capistrano 3.1!!!
#lock '3.1.0'

set :application, "kindergarten"
set :repo_url, "git@github.com:ivanfefilov/kindergarten.git"
...
set :linked_files, %w{config/database.yml config/application.yml config/secrets.yml db/production.sqlite3} # Rails 4.1 uses secrets.yml file
set :linked_dirs, %w{log tmp/pids tmp/sockets tmp/cache public/uploads public/attachment public/assets}
